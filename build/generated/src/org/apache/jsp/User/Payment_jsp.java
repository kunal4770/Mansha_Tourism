...
public final class Payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar due =$('#due').val();\n");
      out.write("\t\tvar cardname = $('#cardname').val();\n");
      out.write("\t\tvar cardnumber = $('#cardnumber').val();\n");
      out.write("\t\tvar cvv = $('#cvv').val();\n");
      out.write("\t\tif(cardnumber==null&&cardnumber.equals(\"\")&&cvv==\"\"&&cvv==null){\n");
      out.write("\t\t\t$('#validation').html(\"invalid\");\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t}else{\n");
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\ttype:'POST',\n");
      out.write("\t\t\tdata:{ packagename:packagename, place:place, email:email,due:due,cardname:cardname,cardnumber:cardnumber,cvv:cvv},\n");
      out.write("\t\t\turl:'../Payment',\n");
      ...
      out.write("\t\t\t    \t\t\t\t");
								...
								String total = request.getParameter("packageCost");
								int discount=0;
									...
									if(rs.next()){
										String discount1 =rs.getString(2);
										System.out.println("tamount@"+tamount);
										int dic=(tamount*(10+discount))/100;
      ...
      out.write("\" type=\"text\" id=\"packagename\" name=\"packagename\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" value=\"");
      out.print(place);
      out.write("\" type=\"text\" id=\"place\" name=\"place\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.print(email);
      out.write("\" id=\"email\" name=\"email\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" value=\"");
      out.print(total );
      out.write("\" id=\"total\" name=\"total\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" value=\"");
      out.print(total);
      out.write("\" id=\"due\" name=\"due\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t<h4>Please Enter Card Details</h4>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-4\">\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" id=\"cardname\" name=\"cardname\" required=\"true\">\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-4\">\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" value=\"\" id=\"cardnumber\" name=\"cardnumber\" required=\"true\" required pattern=\"[0-9]{16}\" maxlength=\"16\">\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-4\">\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" id=\"cvv\" value=\"\" name=\"cvv\" required=\"true\" required pattern=\"[0-9]{3}\" maxlength=\"3\">\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"text-center\">\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\"> \n");
      out.write("\t\t\t    \t\t\t\t\t<input type=\"button\" id=\"button\" value=\"Pay\" class=\"btn btn-primary\">\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
