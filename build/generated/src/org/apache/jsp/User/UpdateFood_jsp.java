...
public final class UpdateFood_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Modify Food</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <script type=\"text/javascript\">\n");
      out.write("$(document).ready(function(){\n");
      out.write("\t\n");
      out.write("\tvar foodCost = $('#foodCost').val();\n");
      out.write("\tvar quantity= $('#quantity').val();\n");
      out.write("\tvar totalCost = foodCost*quantity;\n");
      out.write("\t$('#totalCost').val(totalCost);\n");
      out.write("\t\n");
      ...
      out.write("\t\tvar type = $('#foodType').val();\n");
      out.write("\t\tvar foodName = $('#foodName').val();\n");
      out.write("\t\tvar foodCost = $('#foodCost').val();\n");
      out.write("\t\tvar quantity =$('#quantity').val();\n");
      ...
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\ttype:'POST',\n");
      out.write("\t\t\tdata:{ type:type, foodName:foodName, foodCost:foodCost,quantity:quantity,totalCost:totalCost,packagename:packagename,place:place},\n");
      out.write("\t\t\turl:'../ModifyFood1',\n");
      ...
      out.print(session.getAttribute("foodType") );
      out.write("\" id=\"foodType\" name=\"foodType\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" value=\"");
      out.print(session.getAttribute("foodName") );
      out.write("\" id=\"foodName\" name=\"foodName\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t    \t\t\t\t\t<input class=\"form-control\" type=\"text\" value=\"");
      out.print(session.getAttribute("foodCost") );
      out.write("\" id=\"foodCost\" name=\"foodCost\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\" type=\"text\" id=\"quantity\" name=\"quantity\" required=\"true\">\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\" type=\"text\" id=\"totalCost\" name=\"totalCost\" required=\"true\" readonly>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t<div class=\"col-sm-12\">\n");
      ...
      out.write("\t\t\t    \t\t\t\t\t\t<input type=\"button\" id=\"button\" value=\"Modify Food\" class=\"btn btn-primary\">\n");
      out.write("\t\t\t    \t\t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
      out.write("\t\t\t    \t\t\t\t</div>\n");
