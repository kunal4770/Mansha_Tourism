...
$(document).ready(function(){
	$('#button').click(function(){
		...
		$.ajax({
			type:'POST',
			data:{ packagename:packagename, place:place, email:email,packagecost:packagecost,cardname:cardname,cardnumber:cardnumber,cvv:cvv},
			url:'../Payment',
			    	...
			    	<div class="row">
			    		<div class="col-sm-12">
			    			...
			    			<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="<%=packagecost %>" id="packagecost" name="packagecost" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
